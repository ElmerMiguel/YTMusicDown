...
def descargar_playlist(url, download_dir, progress_var, status_var):
    try:
        ...
        messagebox.showinfo("exito", "Descarga completada con exito!")
...
def iniciar_descarga():
    ...
    if url and download_dir:
        ...
        messagebox.showwarning("Advertencia", "Por favor, ingresa una URL valida y selecciona una carpeta de destino.")
...
ttk.Label(root, text="Descargador de album YTMusic - por ElmerMiguel").pack(pady=5)
